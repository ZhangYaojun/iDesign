...
class Category(models.Model):
    typ = models.CharField(max_length=20, verbose_name='所属类别')
    name = models.CharField(max_length=30, verbose_name='分类名称')
    index = models.IntegerField(default=1,verbose_name='分类的排序')
    #0代表传统，1代表现代，2代表其他
    sex = models.IntegerField(default=0,verbose_name='大类')
...
class Brand(models.Model):
    name = models.CharField(max_length=30, verbose_name='手工业者')
    index = models.IntegerField(default=1,verbose_name='排列顺序')
...
class Clothing(models.Model):
    ...
    brand = models.ForeignKey(Brand, verbose_name='手工业者')
